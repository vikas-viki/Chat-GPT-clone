      ...
      <section className={`chatbox ${mode === 'dark' ? 'bg-dark' : 'bg-white'}`} >
        ...
        <div className='chat-log'>
          {chatLog.length > 0 ?
            ...
            <h1 className='start-converstion' >
              ChatGPT 2.0<br />
              <span className='sub-text'>Ask anything that you need support with.</span>
            </h1>
          }
        </div>
        ...
        <div className={`chat-input blur`} >
          ...
          <div className='chat-about'>
            <span>Chat GPT 2.0 _ built on top of open AI's API & React JS.</span>
          </div>
        </div>
      </section>
    </div>
        ...
        <div className={`avatar ${message.user === 'chatgpt' && 'chatGPT'}`}>
          {
            ...
            <svg width="30" height="30" viewBox="0 0 41 41" fill="none" xmlns="http://www.w3.org/2000/svg" strokeWidth="1.5" className="h-6 w-6">
